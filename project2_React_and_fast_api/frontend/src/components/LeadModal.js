				...
				<section className='modal-card-body'>
					<form>
						...
						<div className='field'>
							...
							<div className='control'>
								<input type='text' placeholder='Enter company' value={company} onChange={(e) => setCompany(e.target.value)} className='input' />
							</div>
						</div>
						<div className='field'>
						...
						<div className='field'>
							...
							<div className='control'>
								<input type='text' placeholder='Enter note' value={note} onChange={(e) => setNote(e.target.value)} className='input' />
							</div>
						</div>
					</form>
				</section>
